...
/*   Updated: 2024/03/15 14:08:57 by jhoratiu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	character_animated(t_complete *param)
{
	...
	while (i < 4)
	{
		...
		param->player_f[i] = load_xpm_image(param, file_path);
		i++;
	}
	i = 0;
	while (i < 5)
	{
		...
		param->p_run_f[i] = load_xpm_image(param, file_path);
		i++;
	}
	i = 0;
	while (i < 4)
	{
		...
		param->atk_unit_f[i] = load_xpm_image(param, file_path);
		i++;
	}
}
...
void	enemy_animated(t_complete *param)
{
	...
	while (i < 4)
	{
		...
		param->enemy_f[i] = load_xpm_image(param, file_path);
		i++;
	}
	i = 0;
	while (i < 3)
	{
		...
		param->atk_enemy_f[i] = load_xpm_image(param, file_path);
		i++;
	}
}
...
void	collectible_animated(t_complete *param)
{
	...
	while (i < 4)
	{
		...
		param->collect_f[i] = load_xpm_image(param, file_path);
		i++;
	}
}
...
void	exit_animated(t_complete *param)
{
	...
	while (i < 4)
	{
		...
		printf("file_path: %s\n", file_path);
		param->exit_f[i] = load_xpm_image(param, file_path);
		i++;
	}
}